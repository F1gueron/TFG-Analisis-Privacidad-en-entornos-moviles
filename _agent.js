...
frida_java_bridge_default.perform(function() {
  ...
  var ProcessBuilder = frida_java_bridge_default.use("java.lang.ProcessBuilder");
  var Process2 = frida_java_bridge_default.use("java.lang.Process");
  function createFakeProcess() {
    var ByteArrayInputStream = frida_java_bridge_default.use("java.io.ByteArrayInputStream");
    var ByteArrayOutputStream = frida_java_bridge_default.use("java.io.ByteArrayOutputStream");
    var fakeProcess = Process2.$new();
  ...
  Runtime2.exec.overload("java.lang.String", "[Ljava.lang.String;").implementation = function(cmd, env) {
  ...
  Runtime2.exec.overload("[Ljava.lang.String;", "[Ljava.lang.String;").implementation = function(cmds, env) {
    var cmd = cmds.join(" ");
    console.log("[BYPASS-ROOT] Runtime.exec[] with env: " + cmd);
    if (cmd.indexOf("su") != -1 || cmd.indexOf("which") != -1) {
      console.log("[BYPASS-ROOT] Command blocked! Returning fake process.");
  ...
  var Build = frida_java_bridge_default.use("android.os.Build");
  Build.TAGS.value = "release-keys";
  try {
    var SystemProperties = frida_java_bridge_default.use("android.os.SystemProperties");
  ...
  try {
    var PackageManager = frida_java_bridge_default.use("android.app.ApplicationPackageManager");
    PackageManager.getPackageInfo.overload("java.lang.String", "int").implementation = function(pkg, flags) {
      ...
      if (dangerous_packages.indexOf(pkg) != -1) {
        ...
        var NameNotFoundException = frida_java_bridge_default.use("android.content.pm.PackageManager$NameNotFoundException");
  ...
  try {
    var UnixFileSystem = frida_java_bridge_default.use("java.io.UnixFileSystem");
  ...
  try {
    ...
    TrustManagerImpl.checkTrustedRecursive.implementation = function(certs, host, clientAuth, untrustedChain, trustAnchorChain, used) {
      ...
      return frida_java_bridge_default.use("java.util.ArrayList").$new();
    };
  } catch (e) {
    console.log("[ERROR] checkTrustedRecursive hook failed: " + e);
  }
  try {
    var TelephonyManager = frida_java_bridge_default.use("android.telephony.TelephonyManager");
  ...
  try {
    var Debug = frida_java_bridge_default.use("android.os.Debug");
